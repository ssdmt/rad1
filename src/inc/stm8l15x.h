...
#define __ICCSTM8__  // suppert IAR compiler
#define __SDCC__     // my define compiler
#define STM8L15X_LD  //STM8L15X_HD  STM8L15X_MDP  STM8L15X_MD
...
#elif defined(_RAISONANCE_) /*_IAR*/
